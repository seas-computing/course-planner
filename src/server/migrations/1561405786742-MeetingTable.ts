...
export class MeetingTable1561405786742 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "meeting" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "startTime" TIME WITH TIME ZONE NOT NULL, "endTime" TIME WITH TIME ZONE NOT NULL, "day" "meeting_day_enum" NOT NULL, "nonClassEventId" uuid, "courseInstanceId" uuid, CONSTRAINT "PK_dccaf9e4c0e39067d82ccc7bb83" PRIMARY KEY ("id"))');
