 ...
 * Plan tab.
 */
export class MultiYearPlanViews1587391924346 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE VIEW "MultiYearPlanView" AS SELECT "c"."id" AS "id", "c"."title" AS "title", "a"."name" AS "area", "instances"."id" AS "instances_id", "instances"."academicYear" AS "instances_academicYear", "instances"."calendarYear" AS "instances_calendarYear", "instances"."term" AS "instances_term", CONCAT_WS(\' \', "c"."prefix", "c"."number") AS "catalogNumber" FROM "course" "c" LEFT JOIN "area" "a" ON c."areaId" = "a"."id"  LEFT JOIN "MultiYearPlanInstanceView" "instances" ON "c"."id" = instances."courseId"', undefined);
    await queryRunner.query('INSERT INTO "typeorm_metadata"("type", "schema", "name", "value") VALUES ($1, $2, $3, $4)', ['VIEW', 'public', 'MultiYearPlanView', "SELECT \"c\".\"id\" AS \"id\", \"c\".\"title\" AS \"title\", \"a\".\"name\" AS \"area\", \"instances\".\"id\" AS \"instances_id\", \"instances\".\"academicYear\" AS \"instances_academicYear\", \"instances\".\"calendarYear\" AS \"instances_calendarYear\", \"instances\".\"term\" AS \"instances_term\", CONCAT_WS(' ', \"c\".\"prefix\", \"c\".\"number\") AS \"catalogNumber\" FROM \"course\" \"c\" LEFT JOIN \"area\" \"a\" ON c.\"areaId\" = \"a\".\"id\"  LEFT JOIN \"MultiYearPlanInstanceView\" \"instances\" ON \"c\".\"id\" = instances.\"courseId\""]);
  }
