...
describe('AuthModule', function () {
  ...
  describe('strategy injection', function () {
    ...
    it('should inject the passed strategies into the providers array', async function () {
      deepStrictEqual(
  ...
  describe('defaultStrategy', function () {
    let ppspy: SinonSpy;
    context('When a defaultStrategy is provided', async function () {
      beforeEach(async function () {
    ...
    context('When a defaultStrategy is NOT provided', async function () {
      beforeEach(async function () {
        strategies = [
          SAMLStrategy,
          DevStrategy,
